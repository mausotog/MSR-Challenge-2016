...
a similar set of questions in 5 projects. In this paper we have studied a much larger dataset~\cite{dyer2013} with 380,125 repositories, and we also study
replacements, omitted from Zhong and Su's analysis.  Barr et al.~\cite{Barr14fse} studied changes to
...
difference. Moreover, our detection is imprecise, and might represent an upper
