...
beyond an initial dataset, and that more work remains to categorize the programmer's fixing behavior.
...
\begin{figure*}[!t] \centering \includegraphics[height=0.23\textheight,
